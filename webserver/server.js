...
// Replace <IP-ADDRESS> with the actual IP address you got from the serial monitor in arduino IDE
const esp32CamIP = //<IP-ADDRESS>;
...
app.get('/capture', async (req, res) => {
  try {
    ...
    const photoResponse = await axios.get(`http://${esp32CamIP}/saved-photo`, { responseType: 'arraybuffer' });
